...
image::images/11-02-Alipay-Cross-border/AlipayCrossborder_logo.jpg[alt=Alipay Cross-border logo, width=200, align="right"]
...
[#API_AlipayCrossBorder_Fields_auto-debit]
===== _auto-debit_
...
[#API_AlipayCrossBorder_Features_auto-debit]
===== _auto-debit_
...
[#API_AlipayCrossBorder_Features_auto-debit_Workflow]
====== Workflow
...
[#API_AlipayCrossBorder_Samples_General_refund-debit]
====== _refund-debit_
...
[#API_AlipayCrossBorder_Samples_auto-debit]
===== _auto-debit_
